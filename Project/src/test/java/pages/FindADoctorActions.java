...
public class FindADoctorActions {
     ...
     * This method types the specified text into the search bar located by the given
     * locator.
    ...
    /**
     * Author: Kiruthik Vijey Raj P
     * This method interacts with various filter sections on the "Find a Doctor"
     * page.
     * It waits for elements to be clickable or visible, clicks on them, and enters
    ...
    public void filterSection() {
        ...
        driverHelper.typeText(FindADoctorLocators.FindADoctorLocators_Language,
                ExcelReader.readCellValue("Sheet1", "13", "value"));
        driverHelper.pressEnter(FindADoctorLocators.FindADoctorLocators_Language);
    }

    /**
     * Author: Kiruthik Vijey Raj P
     * This method clicks on the "Find a Doctor" button and handles the resulting
     * actions.
     * It waits for the element to be clickable, clicks it, switches to a new
     * window, takes a screenshot, and attaches it to the report.
     *
