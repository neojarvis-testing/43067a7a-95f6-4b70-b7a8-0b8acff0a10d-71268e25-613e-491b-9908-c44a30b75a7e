...
public class RequestAppointmentActions 
{
    ...
    public void fillTheDetails(ExtentTest test)
    {
        ...
        driverHelper.selectByValue(RequestAppointmentLocators.RequestAppointment_Gender, "Male");
        test.log(Status.INFO, "Selected Male in DropDown");
        driverHelper.selectByValue(RequestAppointmentLocators.RequestAppointment_MaritalStatus, "Single");
        test.log(Status.INFO, "Selected Single in DropDown");
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_DOB, ExcelReader.readCellValue("Sheet1", "3", "value"));
    ...
    {
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_Address, ExcelReader.readCellValue("Sheet1", "4", "value"));
        test.log(Status.INFO, "Entered Address in the Input Field");
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_City, ExcelReader.readCellValue("Sheet1", "5", "value"));
        ...
        driverHelper.selectByVisibleText(RequestAppointmentLocators.RequestAppointment_StateCategory, ExcelReader.readCellValue("Sheet1", "10", "value"));
        test.log(Status.INFO, "Selected State in DropDown");
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_Email, ExcelReader.readCellValue("Sheet1", "6", "value"));
        test.log(Status.INFO, "Entered Email in the Input Field");
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_Zipcode, ExcelReader.readCellValue("Sheet1", "7", "value"));
        test.log(Status.INFO, "Entered Zipcode in the Input Field");
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_Phone_number, ExcelReader.readCellValue("Sheet1", "8", "value"));
    ...
    {
        driverHelper.typeText(RequestAppointmentLocators.RequestAppointment_Reason, ExcelReader.readCellValue("Sheet1", "9", "value"));
